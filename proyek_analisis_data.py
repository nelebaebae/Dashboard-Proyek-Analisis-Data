...
uploaded_order_items = st.file_uploader("Upload Order Items Dataset", type=["csv"])
uploaded_order_reviews = st.file_uploader("Upload Order Reviews Dataset", type=["csv"])
...
uploaded_payments = st.file_uploader("Upload Order Payments Dataset", type=["csv"])

if uploaded_customers and uploaded_order_items and uploaded_order_reviews and uploaded_orders and uploaded_products and uploaded_payments:
    customers_df = pd.read_csv(uploaded_customers)
    order_items_df = pd.read_csv(uploaded_order_items)
    order_review_df = pd.read_csv(uploaded_order_reviews)
    orders_df = pd.read_csv(uploaded_orders)
    products_df = pd.read_csv(uploaded_products)
    order_payments = pd.read_csv(uploaded_payments)
